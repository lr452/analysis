...
cube1_n = np.mean(cube1d_average.data[28])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube2_n = np.mean(cube2d_average.data[26])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube3_n = np.mean(cube3d_average.data[26])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube4_n = np.mean(cube4d_average.data[27])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube5_n = np.mean(cube5d_average.data[19])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube6_n = np.mean(cube6d_average.data[29])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube7_n = np.mean(cube7d_average.data[29])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube8_n = np.mean(cube8d_average.data[30])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube9_n = np.mean(cube9d_average.data[26])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
cube10_n = np.mean(cube10d_average.data[28])#.collapsed(['latitude'],iris.analysis.MEAN,weights=grid_areas)
...
#Load wind data
flux_variable = np.array([0.000074, 0.000342, 0.000136, 0.0000595, 0.000124, 0.0003487, 0.00008898, -0.000196, 0.0000853, 0.00009398])


variable1 = [cube1_dic, cube2_dic, cube3_dic, cube4_dic, cube5_dic, cube6_dic, cube7_dic, cube8_dic, cube9_dic, cube10_dic]
variable2 = flux_variable 
