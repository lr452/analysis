...
fig, ax = plt.subplots()
ax.plot(variable1a, variable2a,label='ACCESS-ESM1-5', linestyle='dotted', color='orangered')
ax.plot(variable1b, variable2b,label='CanESM5', linestyle='dashed', color='gold')
ax.plot(variable1c, variable2c,label='CESM2', linestyle='dashdot', color='yellowgreen')
ax.plot(variable1d, variable2d,label='GFDL-CM4', linestyle='solid', marker='*', markersize=4, color='dimgrey')
ax.plot(variable1e, variable2e,label='GISS-E2-1-G', linestyle='solid', marker='o', markersize=4, color='mediumaquamarine')
ax.plot(variable1f, variable2f,label='IPSL-CM6A-LR', linestyle='solid', marker='v', markersize=4, color='deepskyblue')
ax.plot(variable1g, variable2g,label='MIROC-ES2L', linestyle='solid', marker='p', markersize=4, color='darkviolet')
ax.plot(variable1h, variable2h,label='MPI-ESM1-2-LR', linestyle='solid', marker='8', markersize=4, color='hotpink')
ax.plot(variable1i, variable2i,label='NorESM2-MM', linestyle='solid', marker='H', markersize=4, color='steelblue')
ax.plot(variable1j, variable2j,label='UKESM1-0-LL', linestyle='solid', marker='X', markersize=4, color='darkcyan')
ax.set_facecolor('whitesmoke')
ax.grid(True)
plt.xlabel('Latitude [$^\circ$S]', fontsize=9, fontweight='bold')
plt.ylabel('DIC [mol m-3]', fontsize=9, fontweight='bold')
plt.xlim([-65, -40])
plt.ylim([2.05, 2.3])
plt.xticks(fontsize=9, fontweight='bold')
plt.yticks(fontsize=9, fontweight='bold')
plt.legend(bbox_to_anchor=(1.02,0.8), loc='centre left', fontsize=4, frameon=False, prop=dict(weight='bold', size=9))
plt.tight_layout()
plt.show()
